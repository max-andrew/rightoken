...
export default function Mint() {
	...
	async function mintRightokenERC20() {
		...
		try {
			if (chainId !== 421611 && chainId !== 42161) {
				throw "Please connect to an Arbitrum network"
			}
	...
	async function listRightokenERC20() {
		...
		try {
			...
			else if (chainId !== 421611 && chainId !== 42161) {
				throw "Please connect to an Arbitrum network"
			}
	...
	const mintStepPages = [
		...
		},
		{
			...
			additionalContent: <SwitchNetworkButton chainId={chainId} library={library}/>,
